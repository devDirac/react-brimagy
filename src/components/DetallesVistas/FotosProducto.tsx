...
interface DetalleFotosProps {
  verFotos?: Fotos[] | null;
  procesandoFotosProducto: boolean;
  datosProducto: any;
  subirFotosProducto: (data: FormData) => Promise<void>;
  fotosProductoFiles: File[];
  setFotosProductoFiles: React.Dispatch<React.SetStateAction<File[]>>;
...
const FotosProductoModal = ({
  ...
  const handleChangeFotosProducto = (newFiles: File[] | null) => {
    setFotosProductoFiles(newFiles || []);
  };
          ...
          <Paper elevation={2} sx={{ p: 2 }}>
            ...
            <Grid container spacing={2}>
              ...
              <Grid item xs={12} sm={8}>
                <MuiFileInput
                  value={fotosProductoFiles}
                  onChange={handleChangeFotosProducto}
              ...
              <Grid item xs={12} sm={4}>
                <Button
                  ...
                  disabled={fotosProductoFiles.length === 0 || procesandoFotosProducto}
                  onClick={(e: any) => {
                    ...
                    <Grid item xs={6} sm={3} key={key}>
                      ...
                      >
                        <CardContent
                          ...
                          onClick={() => {
                            handleOpenVistaFotosProducto(f);
                          }}
                        >
                          <Box
                            sx={{
                ...
                <Grid item xs={12} sm={12}>
                  ...
                  >
                    <Typography variant="h6" color="text.secondary">
                      {intl.formatMessage({ id: "no_hay_fotos_registradas" })}
                    </Typography>
                  </Box>
                </Grid>
              )}
...
export default FotosProductoModal;
