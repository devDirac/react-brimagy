...
interface DetalleFotoMontoProps {
  verFotoMonto?: FotoMonto[] | null;
  procesandoFotoMonto: boolean;
  datosProducto: any;
  subirFotoMonto: (data: FormData) => Promise<void>;
  fotoMontoFiles: File[];
  setFotoMontoFiles: React.Dispatch<React.SetStateAction<File[]>>;
...
const FotoMontoModal = ({
  ...
  const handleChangeFotoMonto = (newFiles: File[] | null) => {
    setFotoMontoFiles(newFiles || []);
  };
          ...
          <Paper elevation={2} sx={{ p: 2 }}>
            ...
            <Grid container spacing={2}>
              ...
              <Grid item xs={12} sm={8}>
                <MuiFileInput
                  value={fotoMontoFiles}
                  onChange={handleChangeFotoMonto}
              ...
              <Grid item xs={12} sm={4}>
                <Button
                  ...
                  disabled={fotoMontoFiles.length === 0 || procesandoFotoMonto}
                  onClick={(e: any) => {
                ...
                >
                  ...
                  ) : verFotoMonto.length > 0 ? (
                    intl.formatMessage({ id: "put_general_foto_monto" })
                  ) : (
                    intl.formatMessage({ id: "set_general_foto_monto" })
                  )}
                </Button>
              </Grid>
            </Grid>
            ...
            <Grid container spacing={2}>
              {verFotoMonto.length > 0 ? (
                verFotoMonto.map((f: any, key: number) => {
                  return (
                ...
                <Grid item xs={12} sm={12}>
                  ...
                  >
                    <Typography variant="h6" color="text.secondary">
                      {intl.formatMessage({ id: "no_hay_foto_registrada" })}
                    </Typography>
                  </Box>
                </Grid>
              )}
